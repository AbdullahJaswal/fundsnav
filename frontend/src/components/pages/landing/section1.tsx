...
const MenuOptions = {
  1: {
    ...
    descrition: "Stay updated with the latest market movements. Capture the pulse of the stock market and identify potential opportunities.",
    ...
    <div className="flex flex-col gap-4 justify-center">
      <div>
        <h1 className="text-2xl md:text-3xl lg:text-4xl text-center font-bold">
          Tailored Tools for Informed Choices
        </h1>
        <p className="text-center text-muted mx-auto text-sm lg:text-base sm:w-3/4 md:w-2/3">
          Equip yourself with our range of analysis tools. From daily trends in stocks to mutual fund performance, we offer a comprehensive view to help you make strategic decisions.
        </p>
      </div>
      ...
      <div className="mx-auto">
        <ul className="menu border border-base-300 menu-horizontal rounded-box">
          <li>
            <a className={`${selectedOption === 1 && "active !bg-primary/20"} hover:bg-primary/10`}
              onClick={() => setSelectedOption(1)}
            >
              {MenuOptions[1].menu_graphic}
              <span className='hidden sm:flex'>
                {MenuOptions[1].menu_title}
              </span>
            </a>
          </li>
          ...
          <li>
            <a className={`${selectedOption === 2 && "active !bg-secondary/20"} hover:bg-secondary/10`}
              onClick={() => setSelectedOption(2)}
            >
              {MenuOptions[2].menu_graphic}
              <span className='hidden sm:flex'>
                {MenuOptions[2].menu_title}
              </span>
            </a>
          </li>
          ...
          <li>
            <a className={`${selectedOption === 3 && "active !bg-accent/20"} hover:bg-accent/10`}
              onClick={() => setSelectedOption(3)}
            >
              {MenuOptions[3].menu_graphic}
              <span className='hidden sm:flex'>
                {MenuOptions[3].menu_title}
              </span>
            </a>
          </li>
        </ul>
      ...
      <div className="card sm:card-side standard-card gap-6 mx-2 md:mx-10 p-10 md:p-20">
        ...
        <div className="card-body basis-1/2 p-2 gap-2">
          ...
          <p className='text-sm md:text-base text-center sm:text-start'>
            {MenuOptions[selectedOption].descrition}
          </p>

          <div className="card-actions justify-end mt-2 mx-auto sm:mx-0">
            <button className={`btn btn-outline w-56 ${MenuOptions[selectedOption].btn_color} ${MenuOptions[selectedOption].bg_glow}`}>
